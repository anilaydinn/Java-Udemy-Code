...
public class Idman {
	...
	public void setBurpeeSayisi(int burpee_sayisi) {
	...
	public int getBurpeeSayisi() {
		...
		return this.burpee_sayisi;
	}
	
	public void setPushUpSayisi(int pushup_sayisi) {
	...
	public int getPushUpSayisi() {
		...
		return this.pushup_sayisi;
	}
	
	public void setSitUpSayisi(int situp_sayisi) {
	...
	public int getSitUpSayisi() {
		...
		return this.situp_sayisi;
	}
	
	public void setSquatSayisi(int squat_sayisi) {
