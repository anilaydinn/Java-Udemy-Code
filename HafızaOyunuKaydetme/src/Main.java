...
public class Main {
	...
	public static void kayittanAl() {
		...
		if(file.exists()) {
			...
			System.out.println("Kaydedilmiş bir oyununuz var. Kayıttan devam etmek ister misiniz ? (yes yada no)");
	...
	public static void main(String[] args) {
		...
		while(oyunBittiMi() == false) {
			...
			System.out.println("Çıkış için q'ya basın... (yes yada no)");
			String cikis = scanner.nextLine();
			
			if(cikis.equals("yes")) {
				
				System.out.println("Oyunu kaydetmek istiyor musunuz ? (yes yada no)");
