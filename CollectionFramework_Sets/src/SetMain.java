...
public class SetMain {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	LinkedHashSet extends HashSet extends AbstractSed implements Set Interface extends Collection extends Iterable
		 	...
		 	LinkedHashSet sınıfı hashtable ile linkedlist yapısını kullanarak elementleri depolar. Bu yüzden,
		 	elementler ekleme sırasına göre depolanır. Ekleme, Çıkarma ve Arama metodları 
