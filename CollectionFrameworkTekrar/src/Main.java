...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 	--------------------------------------------------------------------------------------
		 	List Interface'ı implement'e Eden Classlar
		 	...
		 	Vectorler ----------> Çünkü bazı metodlaro "synchronized" anahtar kelimesiyle yazılmıştır.
		 	...
		 	Variler Anahtar Değer ilişkisiyle depolanır.
		 	Bir key'e karşılık gelen bir değer bulunur.
		 	...
		 	Eğer Queue Interface'inden bir referans ile LinkedList oluşturulursa bu linkedlist aynı zamanda Queue gibi davranır.
		 	...
		 	LIFO (Last in First Out Mantığıyla Çalışır.) Bilgisayarda Recursif fonksiyonlar çalıştırılırken kullanılır.
